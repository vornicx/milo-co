...
for (const file of ['arrow','product-form']) {
...
const base = {request:{locale:{iso_code:'es'}},routes:{root_url:'index.html',cart_url:'cart.html'},cart:{item_count:0},shop:{name:'Milo & Co',policies:[]},settings:{sales_enabled:false},page_title:'Milo & Co',canonical_url:'',content_for_header:''};
